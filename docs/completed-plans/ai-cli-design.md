...
```
hirotm tasks update --board <id-or-slug> <task-id> [--title <text>] [--status <id>] [--list <id>] [--group <id>] [--priority <id>] [--color <css-color> | --clear-color] [--body <text> | --body-file <path> | --body-stdin]
```

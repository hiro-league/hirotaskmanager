...
export function BoardHeader({
  ...
  return (
    <div
      ...
      onMouseEnter={headerScroll.onHeaderMouseEnter}
      onMouseLeave={headerScroll.onHeaderMouseLeave}
      style={{
              ...
              <DropdownMenu.Portal>
                ...
                >
                  <DropdownMenu.Item
                    ...
                    onSelect={onOpenBoardEdit}
                  >
                    Edit board…
                  </DropdownMenu.Item>
                  <DropdownMenu.Item
                    className="cursor-pointer rounded px-2 py-1.5 outline-none hover:bg-accent hover:text-accent-foreground"
                    onSelect={onOpenGroupsEditor}
                  >
                    Task groups
                  </DropdownMenu.Item>
                  <DropdownMenu.Item
                    className="cursor-pointer rounded px-2 py-1.5 outline-none hover:bg-accent hover:text-accent-foreground"
                    onSelect={onOpenPrioritiesEditor}
                  >
                    Task priorities
                  </DropdownMenu.Item>
                </DropdownMenu.Content>
            ...
            <div className="grid min-w-0 grid-cols-1 items-start gap-3 lg:grid-cols-2 2xl:grid-cols-2">
              <div className="min-w-0">
                <TaskGroupSwitcher
                  ...
                  onOpenGroupsEditor={onOpenGroupsEditor}
                />
              </div>
              <div className="min-w-0">
              ...
              <div className="min-w-0">
                <BoardPriorityToggles
                  board={board}
                  headerHovered={headerScroll.headerHovered}
                  onOpenPriorityEditor={onOpenPrioritiesEditor}
                />
              </div>
              <div className="min-w-0">
              ...
              <div className="flex min-w-0 flex-wrap items-center gap-2">
                <div className="min-w-0 flex-1 basis-[min(100%,24rem)]">
                  <ReleaseSwitcher
                    board={board}
                    headerHovered={headerScroll.headerHovered}
                    onOpenReleasesEditor={onOpenReleasesEditor}
                  />
                </div>
